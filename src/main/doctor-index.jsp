		  ...
		  <div class="collapse navbar-collapse" id="navbarmain">
			<ul class="navbar-nav ml-auto">
			  <li class="nav-item active">
				<a class="nav-link" href="doctor-index.jsp">Home</a>
			  </li>
			    <li class="nav-item dropdown">
					<a class="nav-link dropdown-toggle" href="department.html" id="dropdown02" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Patient Appointments <i class="icofont-thin-down"></i></a>
					<ul class="dropdown-menu" aria-labelledby="dropdown02">
						<li><a class="dropdown-item" href="department.html">Pending</a></li>
						<li><a class="dropdown-item" href="department-single.html">Completed</a></li>
					</ul>
			  	</li>
			   <li class="nav-item dropdown">
					<a class="nav-link dropdown-toggle" href="blog-sidebar.html" id="dropdown05" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Welcome, <%=d.getName() %> <i class="icofont-thin-down"></i></a>
					<ul class="dropdown-menu" aria-labelledby="dropdown05">
						<li><a class="dropdown-item" href="doctor-profile.jsp">Profile</a></li>
						<li><a class="dropdown-item" href="doctor-change-passsword.jsp">Change Password</a></li>
						<li><a class="dropdown-item" href="doctor-logout.jsp">Logout</a></li>
					</ul>
			  	</li>
			</ul>
		  </div>
